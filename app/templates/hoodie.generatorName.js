...
Hoodie.extend(function (hoodie) {
  ...
  hoodie.<%= generatorName %> = {
    ...
    following: function (userName) {
      return hoodie.<%= generatorName %>.verifyUser(userName)
        .then(_subscriptions)
    ...
    post: function (postObject, userName) {
      var defer = window.jQuery.Deferred();
      hoodie.<%= generatorName %>.verifyUser(userName)
        .then(function (task) {
  ...
  hoodie.<%= generatorName %>.like = partialRight(hoodie.<%= generatorName %>.count, 'like');
  hoodie.<%= generatorName %>.unlike = partialRight(hoodie.<%= generatorName %>.uncount, 'like');
  hoodie.<%= generatorName %>.abuse = partialRight(hoodie.<%= generatorName %>.count, 'abuse');
