...
module.exports = function (hoodie, pluginDb, userDb) {
  ...
  <%= capitalizeName %>.lookup = function (db, task) {
  ...
  <%= capitalizeName %>.follow = function (db, task) {
  ...
  <%= capitalizeName %>.unfollow = function (db, task) {
  ...
  <%= capitalizeName %>.post = function (db, task) {
  ...
  <%= capitalizeName %>.getPost = function (db, task) {
  ...
  <%= capitalizeName %>.updatePost = function (db, task) {
  ...
  <%= capitalizeName %>.deletePost = function (db, task) {
...
//        async.apply(_setAttrs, task, 'userId'),
  ...
  <%= capitalizeName %>.feed = function (db, task) {
  ...
  <%= capitalizeName %>.comment = function (db, task) {
  ...
  <%= capitalizeName %>.count = function (db, task) {
  ...
  <%= capitalizeName %>.uncount = function (db, task) {
  ...
  <%= capitalizeName %>.getProfile = function (db, task) {
  ...
  <%= capitalizeName %>.updateProfile = function (db, task) {
  ...
  <%= capitalizeName %>.updateComment = function (db, task) {
  ...
  <%= capitalizeName %>.deleteComment = function (db, task) {
  ...
  <%= capitalizeName %>.sharePost = function (db, task) {
