suite('feed', function () {
  ...
  test('hommer should post', function (done) {
    hoodie.<%= generatorName %>.post({text: 'dooh!'})
      .fail(function (err) {
  ...
  test('hommer should edit post', function (done) {
    ...
    hoodie.<%= generatorName %>.updatePost(hommerPost)
      .fail(done)
      .then(function () {
        done();
        assert.ok(true, 'post with success');
  ...
  test('lisa should post', function (done) {
    signinUser('Lisa', '123', function () {
      hoodie.<%= generatorName %>.post({text: 'i m vegan!'})
        .fail(function (err) {
          done((err.message !== 'conflict') ? err: null);
          assert.ok(false, err.message);
        })
  ...
  test('lisa should not delete hommer post', function (done) {
    ...
    hoodie.<%= generatorName %>.deletePost(hommerPost)
      .fail(function () {
        done();
  ...
  test('hommer should get lisa feed', function (done) {
    hoodie.<%= generatorName %>.feed('Lisa')
      .fail(function (err) {
        done(err);
        assert.ok(false, err.message);
      })
 ...
 test('hommer should not edit lisa post', function (done) {
    ...
    hoodie.<%= generatorName %>.updatePost(lisaPost)
      .fail(function () {
        done();
  ...
  test('hommer should not delete lisa post', function (done) {
    ...
    hoodie.<%= generatorName %>.deletePost(lisaPost)
      .fail(function () {
        done();
  ...
  test('hommer should comment lisa post', function (done) {
    ...
    hoodie.<%= generatorName %>.comment(lisaPost, {text: 'vegan means eat bacon right?!'})
      .fail(done)
      .then(function (post) {
  ...
  test('lisa should comment lisa post', function (done) {
    var lisaPost = this.lisaPost;
    signinUser('Lisa', '123', function () {
      hoodie.<%= generatorName %>.comment(lisaPost, {text: 'no daddy bacon is an animal!'})
        .fail(done)
        .then(function (post) {
  ...
  test('bart should comment lisa post', function (done) {
    ...
    signinUser('Bart', '123', function () {
      hoodie.<%= generatorName %>.comment(lisaPost, {text: 'bacon is not animal, right hommer?'})
      .fail(done)
      .then(function (post) {
        assert.ok(true, 'comment with success');
        done();
  ...
  test('homer should comment again lisa post', function (done) {
    var lisaPost = this.lisaPost;
    signinUser('Hommer', '123', function () {
      hoodie.<%= generatorName %>.comment(lisaPost, {text: 'sure bacon is happynes!'})
      .fail(done)
      .then(function (post) {
        assert.ok(true, 'comment with success');
        done();
  ...
  test('homer should like lisa post', function (done) {
    var lisaPost = this.lisaPost;
    hoodie.<%= generatorName %>.count(lisaPost, 'like')
      .fail(done)
      .then(function (post) {
        assert.ok(true, 'comment with success');
        done();
  ...
  test('hommer should unlike lisa post', function (done) {
    var lisaPost = this.lisaPost;
    signinUser('Hommer', '123', function () {
      hoodie.<%= generatorName %>.uncount(lisaPost, 'like')
      .fail(done)
      .then(function (post) {
        assert.ok(true, 'comment with success');
        done();
  ...
  test('cat should like with like lisa post', function (done) {
    ...
    signinUser('Cat', '123', function () {
      hoodie.<%= generatorName %>.like(lisaPost)
      .fail(done)
      .then(function (post) {
        assert.ok(true, 'comment with success');
        done();
  ...
  test('Dog should unlike with unlike lisa post', function (done) {
    var lisaPost = this.lisaPost;
    signinUser('Dog', '123', function () {
      hoodie.<%= generatorName %>.unlike(lisaPost)
      .fail(done)
      .then(function (post) {
        assert.ok(true, 'comment with success');
        done();
  ...
  test('hommer should get lisa post', function (done) {
    var lisaPost = this.lisaPost;
    signinUser('Hommer', '123', function () {
      hoodie.<%= generatorName %>.getPost(lisaPost)
        .fail(done)
        .then(function (post) {
  ...
  test('hommer should not update lisa comment', function (done) {
    ...
    signinUser('Hommer', '123', function () {
      hoodie.<%= generatorName %>.updateComment(lisaPost, lisaComment)
        .fail(function (err) {
  ...
  test('hommer should not delete lisa comment', function (done) {
    ...
    var lisaComment = this.lisaComment;
    signinUser('Hommer', '123', function () {
      hoodie.<%= generatorName %>.deleteComment(lisaPost, lisaComment)
        .fail(function (err) {
          assert.ok(err, 'comment with success');
          done();
        })
  ...
  test('hommer should update his comment', function (done) {
    ...
    signinUser('Hommer', '123', function () {
      hoodie.<%= generatorName %>.updateComment(lisaPost, hommerComment)
        .fail(done)
        .then(function (post) {
  ...
  test('hommer should delete his comment', function (done) {
    ...
    var hommerComment = this.hommerComment;
    signinUser('Hommer', '123', function () {
      hoodie.<%= generatorName %>.deleteComment(lisaPost, hommerComment)
        .fail(function (err) {
          done(err);
        })
        .then(function () {
  ...
  test('hommer should share lisa post', function (done) {
    var lisaPost = this.lisaPost;
    signinUser('Hommer', '123', function () {
      hoodie.<%= generatorName %>.share(lisaPost)
        .fail(function (err) {
          done(err);
        })
        .then(function () {
